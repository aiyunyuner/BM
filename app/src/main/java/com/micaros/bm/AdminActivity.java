...
import com.micaros.bm.admin.admin_content_activity;
...
public class AdminActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        //登录按钮的事件监听
        login_bt = (Button) findViewById(R.id.a_login);
        login_bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (admin.equals(struser) && pwd.equals(strpwd)) {
                    Intent intent = new Intent(AdminActivity.this, admin_content_activity.class);
                    startActivity(intent);
                } else {
